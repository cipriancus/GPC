...
{
public:
	void imag1(double lungime, int nivel, CPunct &p, CVector v)
	{
		CPunct p1;
		if (nivel == 0)
		{
		...
		{
			imag1(lungime, nivel - 1, p, v);
			if (lungime < 1.5) {
				v.rotatie(-90);
				p1 = v.getDest(p, 2*lungime / 3);
				v.rotatie(-90);
				p1 = v.getDest(p1, lungime / 3);
				imag1(lungime / 3.0, nivel - 1, p1, v);
	...
	void afisare(double lungime, int nivel)
	{
		...
		imag1(lungime, nivel, p1, v1);
		imag1(lungime, nivel, p2, v2);
		imag1(lungime, nivel, p3, v3);
		imag1(lungime, nivel, p4, v4);

		imag1(lungime/3.0, nivel, p5, v5);
		imag1(lungime / 3.0, nivel, p6, v6);
		imag1(lungime / 3.0, nivel, p7, v7);
		imag1(lungime / 3.0, nivel, p8, v8);
	}
};
...
public:
	void patrate(double lungime, int nivel, CPunct &p, CVector v)
	{
		...
		{
			patrate(lungime / 5.0, nivel - 1, p, v);
			p1 = v.getDest(p, lungime / 5.0);
			v.rotatie(90);
			patrate(lungime / 5.0, nivel - 1, p1, v);
			p1 = v.getDest(p1, lungime / 5.0);
			//v.rotatie(90);
			patrate(lungime / 5.0, nivel - 1, p1, v);
			p1 = v.getDest(p1, lungime / 5.0);
			v.rotatie(90);
	...
	void afisare(double lungime, int nivel)
	{
		...
		patrate(lungime, nivel, p1, v1);
		patrate(lungime, nivel, p2, v2);
		patrate(lungime, nivel, p3, v3);
		patrate(lungime, nivel, p4, v4);

		patrate(lungime, nivel, p5, v5);
		patrate(lungime, nivel, p6, v6);
		patrate(lungime, nivel, p7, v7);
		patrate(lungime, nivel, p8, v8);
	}
};
